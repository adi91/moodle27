...
/**
 * Moodle's powerup theme, an example of how to make a Bootstrap theme
 *
...
<head>
	...
	<!--[if IE 8]><link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/powerup/style/ie8.css"><![endif]-->
    <!--[if IE 9]><link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot; ?>/theme/powerup/style/ie9.css"><![endif]-->
...
<?php } ?>
          ...
          <?php 
   require_once($CFG->dirroot.'/lib/poweruplib.php');
   
   $courselist = get_courses();
    
//    print_object($courselist);
   ...
   if(has_capability('moodle/site:viewreports', $context) || is_institute_admin()){
       echo teacher_menue('Lessons', $course->id);
    }?>
